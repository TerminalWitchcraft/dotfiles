...
## Type: Int
c.content.cache.maximum_pages = 5
...
## Type: ShellCommand
c.editor.command = ['nvim-gtk', '{file}', '-c', 'normal {line}G{column0}l']
...
c.fonts.monospace = '"Times New Roman", Iosevka'
