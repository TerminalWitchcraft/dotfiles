...
awful.screen.connect_for_each_screen(function(s)
    ...
    awful.tag({ "code", "web", "play", "4", "5", "6", "7", "8", "9" }, s, awful.layout.layouts[1])
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey,           }, "space", function () awful.util.spawn("/usr/bin/rofi -show")          end,
              {description = "launch dmenu", group = "launcher"}),
    awful.key({ modkey, Shift     }, "b", function () awful.util.spawn("/usr/bin/firefox")          end,
...
awful.rules.rules = {
    ...
    { rule = { class = "mpv" },
      properties = { tag = "play", switchtotag = true,} },
    -- Set Firefox to always map on the tag named "2" on screen 1.
    { rule = { class = "Firefox" },
      properties = { tag = "web", floating = false, switchtotag = true, maximized_vertical = false, maximized_horizontal = false } },
}
-- }}}
